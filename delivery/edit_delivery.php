                        ...
                        <div class="panel-body">
                            ...
                            <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                <?php
                                 ...
                                 $today=date("Y-m-d");
                                $sql = "SELECT customers.c_address,customers.c_id,customers.c_phone,customers.c_name,delivery.liters,delivery.remark,delivery.d_id,delivery.d_c_id from customers join delivery on delivery.d_c_id=customers.c_id where delivery.d_date=:today";
                                $query = $link -> prepare($sql);
                                        ...
                                        if(in_array($newroot,$root)){?>
                                            <tr>
                                                ...
                                                <td><form method="post" action="edit_delivery.php?id=<?php echo $result->d_id;?>&num=<?php echo $cnt;?>" >
                                                        ...
                                                        <input type="text" name="remark<?php echo $cnt; ?>" id="remark<?php echo $cnt; ?>" value="<?php echo $result->remark;?>">
