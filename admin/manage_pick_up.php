        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">View Picked</h2>
                    <!-- Zero Configuration Table -->
                    <div class="panel panel-default" style="overflow-x:auto;">
                     <div class="panel-heading">Picked Details</div>
                      <form method="post" >
                        ...
                        <div class="panel-body">
                            ...
                            <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                $date=date("Y-m-d");
                                $sql = "SELECT * from pick where p_date=:date";
                                ...
                                if($query->rowCount() > 0)
                                {
                                    ...
                                    {				?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->p_one_liters);?>+<?php echo htmlentities($result->p_half_liters);?></td>
                                            <td><?php echo $result->p_one_liters+($result->p_half_liters/2);?></td>
                                            <?php if($_SESSION['post'] == "admin"){ ?>
                                            <td><a href="edit_pick_up.php?id=<?php echo $result->p_id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                            <?php }?>
                                        </tr>
                                    <?php }} ?>
                                </tbody>
