                        ...
                        <div class="panel-body">
                            ...
                            <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                if(isset($_GET['submit']))
                                    ...
                                    $today=date("Y-m-d");
                                $sql = "SELECT * from gee_delivery where gd_date=:today";
                                $query = $link -> prepare($sql);
                                $query->bindParam(':today', $today, PDO::PARAM_STR);
                                $query->execute();
                                ...
                                if($query->rowCount() > 0)
                                {
                                    foreach($results as $result)
                                    {
                                        ?>
                                        <tr>
                                            <form method="post" action="gee_delivery.php?id=<?php echo $result->gd_id;?>&num=<?php echo $cnt;?>" >
                                                <td><?php echo $cnt; ?></td>
                                        ...
                                        <?php $cnt=$cnt+1; }} ?>
                                <tr>
                                    <form method="post" action="gee_delivery.php?num=<?php echo $cnt;?>" >
                                        <td><?php echo $cnt; ?></td>
