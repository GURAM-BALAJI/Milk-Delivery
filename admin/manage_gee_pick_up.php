        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">View Gee Picked</h2>
                    <!-- Zero Configuration Table -->
                    <div class="panel panel-default" style="overflow-x:auto;">
                        <div class="panel-heading">Picked Gee Details</div>
                        <form method="post" >
                        ...
                        <div class="panel-body">
                            ...
                            <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                if(isset($_POST['date']))
                                    ...
                                    $date=date("Y-m-d");
                                $sql = "SELECT * from gee_pick where gp_date=:date";
                                ...
                                if($query->rowCount() > 0)
                                {
                                    ...
                                    {				?>
                                        <tr>
                                            <td><?php echo htmlentities($result->gp_id);?></td>
                                            <td><?php echo htmlentities($result->gp_name);?></td>
                                            <td><?php echo htmlentities($result->gp_qty);?></td>
                                            <?php if($_SESSION['post'] == "admin"){ ?>
                                           <td><a href="edit_gee_pick_up.php?id=<?php echo $result->gp_id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <?php } ?>
                                        </tr>
                                    <?php }} ?>
                                </tbody>
