...
if(isset($_GET['del']))
{
    $c_id=$_GET['del'];
    $de=$_GET['delete'];
    $sql = "update customers set c_delete=:de where c_id=:c_id";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">View customers -<a href="export/customer.php"><button>Export All Customers</button></a></h2>
                                ...
                                if($query->rowCount() > 0)
                                {
                                    ...
                                    {				?>
                                        <tr>
                                            ...
                                            <td><a href="edit_customer.php?id=<?php echo $result->c_id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
