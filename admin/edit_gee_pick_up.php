...
if(isset($_POST['submit']))
{
    try {
        ...
        $name=$_POST['delivery'];
        $qty=$_POST['qty'];
        $sql = " update gee_pick set gp_name=:name,gp_qty=:qty,gp_date=:date where gp_id=:id";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">Edit Gee Pick_Up</h2>

                    <div class="row">
                        <div class="col-md-10">
                            <div class="panel panel-default">
                                <div class="panel-heading">Gee Pick_up fields</div>
                                <div class="panel-body">
                                    <form class="form-group-lg" method="post">
                                        ...
                                        <?php
                                        $id=$_GET['id'];
                                        $ret="select * from gee_pick where gp_id=:id";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control"  name="date" id="date" value="<?php echo htmlentities($result->gp_date);?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">NO of Kg's of Gee Picked Today :</label>
                                            <div class="col-sm-8">
                                                <input type="text" autocomplete="on" class="form-control"  name="qty" id="qty" value="<?php echo htmlentities($result->gp_qty);?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="delivery" id="delivery" class="form-control-static" required>
                                                    <option value="<?php echo htmlentities($result->gp_name);?>"><?php echo htmlentities($result->gp_name);?></option>
                                                    <?php
