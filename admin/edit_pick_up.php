...
if(isset($_POST['submit']))
{
    try {
        ...
        $half_milk=$_POST['half_milk'];
            $sql = " update pick set p_name=:name,p_one_liters=:one_milk,p_half_liters=:half_milk,p_date=:date where p_id=:id";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">Edit Pick_Up</h2>

                    <div class="row">
                        <div class="col-md-10">
                            <div class="panel panel-default">
                                <div class="panel-heading">Pick_up fields</div>
                                <div class="panel-body">
                                    <form class="form-group-lg" method="post">
                                        ...
                                        <?php
                                        $id=$_GET['id'];
                                        $ret="select * from pick where p_id=:id";
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control"  name="date" id="date" value="<?php echo htmlentities($result->p_date);?>" required>
                                                </div>
                                            </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">NO of One Liters Milk Bottles Picked Today :</label>
                                            <div class="col-sm-8">
                                                <input type="text" autocomplete="on" class="form-control"  name="one_milk" id="one_milk" value="<?php echo htmlentities($result->p_one_liters);?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">NO of Half Liters Milk Bottles Picked Today :</label>
                                            <div class="col-sm-8">
                                                <input type="text" autocomplete="on" class="form-control"  name="half_milk" id="half_milk" value="<?php echo htmlentities($result->p_half_liters);?>" required>
                                            </div>
                                        </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="delivery" id="delivery" class="form-control-static" required>
                                                        <option value="<?php echo htmlentities($result->p_name);?>"><?php echo htmlentities($result->p_name);?></option>
                                                        <?php
