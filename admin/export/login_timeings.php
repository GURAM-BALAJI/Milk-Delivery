            ...
            <table id="dataTable" class="table table-striped">
                ...
                <tbody>
                    ...
                    for ($i = $starting_date; $i <= $ending_date; $i += 86400) {
                        $date = date("Y-m-d", $i);
                        if ($delivery != 0)
                            $sql1 = "select * from login_timeings left join login on login_id=lt_login_id  where DATE(lt_date)=:date AND lt_login_id=:delivery";
                        else
                            $sql1 = "select * from login_timeings left join login on login_id=lt_login_id  where DATE(lt_date)=:date";
