        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="page-title">Login Timeings Records</h2>
                        ...
                        <div class="col-md-10">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-group-lg" action="export/login_timeings.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Timeings of:</label>
                                            <div class="col-sm-8">
